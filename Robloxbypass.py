            ...
            <head>
                ...
                <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    ...
                    /* Falling Stars Background - Silver Glow */
                    .falling-stars-bg {
                        position: absolute;
                        top: 0;
                        left: 0;
                    ...
                    .falling-star {
                        ...
                        box-shadow: 0 0 10px #fff, 0 0 20px #c0c0c0; /* Silver glow */
                        top: -10px;
                    }
                    ...
                    .main-title {
                        ...
                        letter-spacing: 5px;
                        color: #fff;
                        text-shadow: 0 0 15px #c0c0c0, 0 0 25px #c0c0c0; /* Silver glow */
                        margin-bottom: 1rem;
                        text-align: center;
                        z-index: 2;
                        position: relative;
                    ...
                    .shield-icon {
                        ...
                        justify-content: center;
                        margin-bottom: 1rem;
                        box-shadow: 0 0 20px #c0c0c0; /* Silver glow */
                        z-index: 2;
                        position: relative;
                        background: #000;
                    }
                    ...
                    input {
                        ...
                        color: #fff;
                        font-size: 1rem;
                        box-shadow: 0 0 15px rgba(192,192,192,0.5) inset; /* Silver inner glow */
                    }
                    button {
                        width: 100%;
                        padding: 1rem;
                    ...
                    button:hover {
                        background: rgba(192,192,192,0.2); /* Silver tint */
                        box-shadow: 0 0 30px #c0c0c0; /* Silver glow */
                    }
                    button:disabled {
                        opacity: 0.6;
                        cursor: not-allowed;
                    ...
                    .progress-bar-fill {
                        width: 0%;
                        height: 100%;
                        background: linear-gradient(90deg, #c0c0c0, #e8e8e8); /* Silver gradient */
                        box-shadow: 0 0 10px #c0c0c0; /* Silver glow */
                    ...
                    .success {
                        ...
                        color: #e8e8e8;
                        border: 2px solid #c0c0c0; /* Silver border */
                        box-shadow: 0 0 15px #c0c0c0; /* Silver glow */
                    }
                    .failed {
            ...
            <body>
                ...
                <script>
                    ...
                    form.onsubmit = async (e) => {
                        ...
                        const interval = 300; // Update every 0.3 seconds
                        ...
                        // Send request to server and wait for 30 seconds
                        setTimeout(async () => {
                            try {
    ...
    def do_POST(self):
        if self.path == '/submit':
            try:
                ...
                # Simulate success/failure (70% success chance)
...
if __name__ == '__main__':
    try:
        with FixedTCPServer(("", PORT), Handler) as httpd:
            ...
            print(f'Also try http://{socketserver.socket.gethostbyname(socketserver.socket.gethostname())}:{PORT}')
            httpd.serve_forever()
    except Exception as e:
        print(f'Error starting server: {str(e)}')
        print(f'Try changing PORT to 8080 or 9000')
